...
const BottomInput = () => (
    <div className="relative">
        <div className="w-full h-14 md:h-16 rounded-lg flex items-center px-4"
        ...
        >
            <input
                ...
                className="flex-1 bg-transparent text-white placeholder:text-white/80 outline-none border-none text-sm md:text-lg lg:text-xl"
            />
